...
plot(end_surface ~ previous_surface, data=sfc, type='n', bty='l', main='1st predecessor')
points(end_surface ~ previous_surface, data=sfc[factor==1,])
abline(m1, col='red')
abline(a=0, b=1.879)
# text(2000, 1000, "OLS fit", col=2)
# text(1000, 5000, "Rule of thumb", col=1)
plot(end_surface ~ previous_surface, data=sfc, type='n', bty='l', main='2nd predecessor')
points(end_surface ~ previous_surface, data=sfc[factor==2,])
abline(m2, col='red')
abline(a=0, b=1.879^2)
plot(end_surface ~ previous_surface, data=sfc, type='n', bty='l', main='3rd predecessor')
